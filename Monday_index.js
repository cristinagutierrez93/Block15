...
//     let completeGroup= [...groupOne, ...groupTwo];
...
//     let personWeWillMove= officeStaff[seatNumber];
//     officeStaff.splice(seatNumber, 1, staffMember)
//     officeStaff.push(personWeWillMove)
//     return officeStaff;
// }
...
//         let currentUsersData= companyData[currentUserIndex];
//         console.log(`Username is ${currentUsersData[0]} Password is ${currentUsersData[1]} Email is ${currentUsersData[2]}
//     }
